...
- `NEXT_PUBLIC_ADSENSE_SLOT_CONVERTER_FOOTER`
- `NEXT_PUBLIC_ADSENSE_SLOT_AI_NOTEMAKER_INLINE`
- `NEXT_PUBLIC_ADSENSE_SLOT_AI_NOTEMAKER_FOOTER`
- `NEXT_PUBLIC_ADSENSE_SLOT_RECTANGLE_TOP`
- `NEXT_PUBLIC_ADSENSE_SLOT_RECTANGLE_BOTTOM`
