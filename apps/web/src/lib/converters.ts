...
export const converters: ConverterDefinition[] = [
  ...
  defineConverter({
    ...
    categoryTags: ["image", "code", "extract"],
    acceptExtensions: commonImageExtensions,
    acceptMimeTypes: ["image/*"],
    outputFormat: "txt",
    jobType: "extract",
  ...
  defineConverter({
    ...
    categoryTags: ["code", "generate", "image"],
...
export const converterCategories: ConverterCategory[] = [
  ...
  {
    title: "Scan & Code Tools",
    description: "Decode and generate codes quickly.",
    icon: "scan-code",
    converterSlugs: ["qr-code-scanner", "qr-code-generator", "barcode-scanner"],
  },
  {
    title: "Data Tools",
